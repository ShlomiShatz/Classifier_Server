...
*/
bool ClientVectorCheck::exponentCheck(string s) {
    string sub;
...
*/
string ClientVectorCheck::stringCheckAndFix(string s) {
    string temp, fixed = "";
    stringstream SStr(s);
...
*/
int ClientVectorCheck::kCheck(string knum) {
...
*/
int ClientVectorCheck::distCheck(string input) {
 ...
 * @return the fixed string
*/
string ClientVectorCheck::cutSpaces(string input) {
...
*/
string ClientVectorCheck::paramCheck(string inputParam) {
...
*/
bool ClientVectorCheck::checkIP(string inputParam) {
    stringstream SStr(inputParam);
    string temp, knum;
    int byteIp;
    int counter = 0;
